...
for file in glob.glob("../arranged_dataset/*.xlsx"):
    ...
    for _ in range(3):
        ...
        if _ == 1:
            ...
            ax.plot(dfp["lambda"], dfp["pls_test_r"], color="orange", label="pls", linewidth=1, alpha=0.5)
        else:
            ...
            ax.plot(dfp["lambda"], dfp["pls_test_r"], color="orange",  linewidth=1, alpha=0.5)
        ax.plot(dfp["lambda"],dfp["Gaussian_test_r2"],color="blue",linewidth=2,alpha=0.5)
        ax.plot(dfp["lambda"], dfp["lasso_test_r2"],color="red",linewidth=2,alpha=0.5)
        ax.plot(dfp["lambda"], dfp["ridge_test_r2"],color="green",linewidth=2,alpha=0.5)
        ax.plot(dfp["lambda"], dfp["pls_test_r2"], color="orange",  linewidth=2, alpha=0.5)
