...
if __name__ == '__main__':
    ...
    for param_file_name in ["../parameter_0306/parameter_cbs_gaussian.txt","../parameter_0306/parameter_RuSS_gaussian.txt","../parameter_0306/parameter_dip-chloride_gaussian.txt",]:
