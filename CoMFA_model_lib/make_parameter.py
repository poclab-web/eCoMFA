...
for param_file_name in [
    ...
    "../parameter_0306/parameter_cbs_PLS.txt",
    "../parameter_0306/parameter_cbs_ridgecv.txt",
    "../parameter_0306/parameter_cbs_lassocv.txt",
    "../parameter_0306/parameter_cbs_elasticnetcv.txt",
    "../parameter_0306/parameter_dip-chloride_PLS.txt",
    "../parameter_0306/parameter_dip-chloride_lassocv.txt",
    "../parameter_0306/parameter_dip-chloride_gaussian.txt",
    "../parameter_0306/parameter_dip-chloride_elasticnetcv.txt",
    "../parameter_0306/parameter_dip-chloride_ridgecv.txt",
    "../parameter_0306/parameter_RuSS_gaussian.txt",
    "../parameter_0306/parameter_RuSS_lassocv.txt",
    "../parameter_0306/parameter_RuSS_PLS.txt",
    "../parameter_0306/parameter_RuSS_elasticnetcv.txt",
    "../parameter_0306/parameter_RuSS_ridgecv.txt",
    ...
    try:
    # 文字列置換
        data_lines = data_lines.replace("origin", "0306")
    ...
    try:
    # 文字列置換
        data_lines = data_lines.replace("4.8,1.88,4.88,0.25", "4.3,1.8,5.8,0.4")
