...
df=pd.read_csv("C:/Users/poclabws/result/20240704_0_5_spl5/ElasticNet.csv")
...
df1 = pd.read_excel(file1).dropna(subset=['smiles']).drop_duplicates(subset="inchikey")[["inchikey","smiles",'ΔΔG.expt.']]
df2=pd.read_excel(file2).dropna(subset=['smiles']).drop_duplicates(subset="inchikey")[["inchikey","smiles",'ΔΔG.expt.']]
df3 =pd.read_excel(file3).dropna(subset=['smiles']).drop_duplicates(subset="inchikey")[["inchikey","smiles",'ΔΔG.expt.']]
