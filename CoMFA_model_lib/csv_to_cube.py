...
if __name__ == '__main__':
    ...
    for file in glob.glob(all_file):
        ...
        to_cube_file_name=file [:-3]+"cube"#os.path.splitext(os.path.basename(file))[0]
        with open(to_cube_file_name, "w") as f:
            ...
            for i in range(len(df) // 6 + 1):
                line = df["Gaussian_Dt"].iloc[6 * i:6 * i + 6].values.tolist()
        ...
        #
        #
        #     to_cube_file_name = file + "/" + feature + ".cube"
