...
if __name__ == '__main__':
    ...
    graph_(df_alp,"/Users/mac_poclab/PycharmProjects/CoMFA_model/dataset/regression_ru.png")
    graph_(pd.concat([df_cbs,df_dip,df_alp]),"/Users/mac_poclab/PycharmProjects/CoMFA_model/dataset/regression.png")